...
TEMPLATES: dict[str, dict] = {
    ...
    "osu_taiko": {
        ...
        "bindings": [
            ...
            _b("c0.hit.kat", "key.k", mode="tap", tap_ms=30, comment="right kat (angled stroke or trigger held)"),
            _b("c1.hit.don", "key.f", mode="tap", tap_ms=30, comment="left don"),
            _b("c1.hit.kat", "key.d", mode="tap", tap_ms=30, comment="left kat"),
